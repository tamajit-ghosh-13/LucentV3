...
const supabaseKey = supabasePublishableKey || import.meta.env.VITE_SUPABASE_ANON_KEY || '';

if (!supabaseUrl || !supabaseKey) {
  console.warn('Lucent: Missing Supabase URL or publishable key. Authentication will be unavailable.');
}
